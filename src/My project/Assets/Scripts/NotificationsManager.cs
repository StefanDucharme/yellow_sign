...
public class NotificationsManager : MonoBehaviour
{
    ...
    {
        Debug.Log("Adding listener for " + NotificationName);
    ...
    public void RemoveListener(Component Sender, string NotificationName)
    {
        ...
        {
            //Check instance ID
            if (Listeners[NotificationName][i].GetInstanceID() == Sender.
           GetInstanceID())
    ...
    public void PostNotification(NotificationData data, string NotificationName)
    {
        ...
        foreach (Component Listener in Listeners[NotificationName])
            Listener.SendMessage(NotificationName, data, SendMessageOptions.
           DontRequireReceiver);
    }
    //------------------------------------------------
